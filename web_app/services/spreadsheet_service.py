...
from web_app.models.product import DEFAULT_PRODUCTS, Product
...
class SpreadsheetService:
    ...
    def create_record(self, sheet_name:str, new_record:dict):
        return self.create_records(sheet_name, [new_record])

    def seed_products(self):
        _, products = self.get_records("products")
        if not any(products):
            self.create_records("products", DEFAULT_PRODUCTS)
